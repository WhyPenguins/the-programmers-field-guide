...
3. MSYS2 comes with a number of terminal environments.
   We want to use a specific one. To do this, open the Windows start menu, and search for "MINGW64".
...
4. Open the **MSYS2 MINGW64** Terminal using **"Run as Administrator"**
