...
<div class="not-content">
  <YouTube id="ob_GX50Za6c" params="fs=1&start=25&modestbranding=1&rel=0" posterQuality="max"/>
</div>
...
This capability makes computers very useful. If we can imagine a useful digital reality and create this using programming tools, then this reality will exist within the computers running our program. Your code will get the computer to respond in meaningful ways to inputs, and generate meaningful changes in the real world (outputs).
