...
<div class="not-content">
  <YouTube id="GlnX27vD5pw" params="fs=1&modestbranding=1&rel=0" posterQuality="max"/>
</div>
...
- As with [branching](/book/part-1-instructions/3-control-flow/5-reference/03-0-branching), looping statements have a single entry and a single exit.
