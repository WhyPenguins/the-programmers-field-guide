...
- works well with a [for loop](/book/part-1-instructions/3-control-flow/5-reference/04-3-for-loop), as the for loop can iterate over the valid indexes allowing you to process each element of the array.
...
<div class="not-content">
  <YouTube id="dAHY-LyTRW0" params="fs=1&modestbranding=1&rel=0" posterQuality="max"/>
</div>
