...
<div class="not-content">
  <YouTube id="WRkobQcz9ik" params="fs=1&modestbranding=1&rel=0" posterQuality="max"/>
</div>
...
To this point, data has been about single values that are either numbers, text, or Boolean values. These values can be used in [expressions](/book/part-1-instructions/1-sequence/5-reference/13-expression) and stored in [variables](/book/part-1-instructions/2-data/5-reference/10-variable). Now as we move to creating larger and more complicated programs, you need a more effective means of modelling the data in your code. This chapter introduces concepts that you can use to more accurately model the data and entities associated with your program.

This chapter introduces the following **building blocks**:

- [Enumeration](/book/part-2-organised-code/2-structuring-data/5-reference/03-02-enum): used to store one of a list of available options.
- [Struct](/book/part-2-organised-code/2-structuring-data/5-reference/03-01-struct): used to store multiple fields in a single composite value.
...
- [Local Variable](/book/part-2-organised-code/1-structuring-code/5-reference/03-local-variable): Storing data in a or [Function](/book/part-2-organised-code/1-structuring-code/5-reference/04-function-decl) or [Procedure](/book/part-2-organised-code/1-structuring-code/5-reference/02-procedures).
- [Parameter](/book/part-2-organised-code/1-structuring-code/5-reference/04-function-decl#examples): Passing data to a [Function or Procedure](/book/part-2-organised-code/1-structuring-code/5-reference/00-0-functions-and-procedures).

The following programming terminology will also be used in this chapter:

- [Expression](/book/part-1-instructions/1-sequence/5-reference/13-expression): A value used in a statement.
- [Type](/book/part-1-instructions/1-sequence/5-reference/15-type): A kind of data used in your code.
