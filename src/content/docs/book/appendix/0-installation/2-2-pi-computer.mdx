...
<div class="not-content">
  <YouTube id="iQEsXnfwpqA" params="fs=1&modestbranding=1&rel=0" posterQuality="max"/>
</div>
...
We will first look at the hardware you need, and where you can get it, and then we can look at the software you need and how you can install that using the [Terminal](/book/appendix/2-computer-use/2-trailside/01-terminal) on your Pi.
...
[Set up my Linux Box](/book/appendix/0-installation/2-0-setup-linux)
:::
...
- [Raspberry Pi GPIO Breakout Lead and Header for breadboard](https://www.jaycar.com.au/raspberry-pi-gpio-breakout-lead-and-header-for-breadboard/p/XC9042)
...
- [Argon ONE V2 Raspberry Pi 4 Case](https://core-electronics.com.au/argon-one-v2-raspberry-pi-4-case.html)
    ...
    Also available at [Altronics](https://www.altronics.com.au/p/h8952a-argon-one-v2-case-to-suit-raspberry-pi-4/).
...
:::tip
Using your own SD card? Make sure you have installed Raspberry Pi OS on it. You can find the instructions in the [Set up my Raspberry Pi](/book/appendix/0-installation/2-3-setup-pi) section.
...
## 5. Finalising the Multi-tool Setup
...
To continue the setup process, continue to the next page: [Set up my Raspberry Pi](/book/appendix/0-installation/2-3-setup-pi) for instructions on how to install the operating system and configure the Pi.
