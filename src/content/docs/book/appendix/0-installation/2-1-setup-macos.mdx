...
<div class="not-content">
  <YouTube id="3CHGbyVY2F8" params="fs=1&modestbranding=1&rel=0" posterQuality="max"/>
</div>
:::
...
<div class="not-content">
  <YouTube id="i2g9br8Y9Jc" params="fs=1&modestbranding=1&rel=0" posterQuality="max"/>
</div>
:::
...
<div class="not-content">
  <YouTube id="KlT_PCoc0pw" params="fs=1&modestbranding=1&rel=0" posterQuality="max"/>
</div>
:::
...
<div class="not-content">
  <YouTube id="ABJJMuzzbgA" params="fs=1&modestbranding=1&rel=0" posterQuality="max"/>
</div>
:::
