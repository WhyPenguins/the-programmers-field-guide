---
title: "How to read syntax diagrams"
---
...
<div class="not-content">
  <YouTube id="8KeyfyVdsD0" params="fs=1&modestbranding=1&rel=0" posterQuality="max"/>
</div>

_Note: This video mentions C# rather than C++ -- luckily the syntax we cover here is identical!_
...
![Figure 5.12 The syntax of an Identifier.](./images/identifier.png "The syntax of an Identifier")
